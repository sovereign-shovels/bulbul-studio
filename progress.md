...
- [x] Core functionality on primary platform (text → Bulbul v3 TTS → audio file)
...
- 2026-05-10 — v0.1 built — Tauri v2 desktop app, Bulbul v3 API integration, audio preview + save
